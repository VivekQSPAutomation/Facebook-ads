...
class Socialinks(Basepages):
    ...
    socail_link= (By.XPATH,"(//div[@class='wrapper influencerApplicationCardPopover']//button)[3]")
    ...
    def social_links(self):
        ...
        elements = WebDriverWait(self.driver, 10).until(
            EC.presence_of_all_elements_located((By.XPATH, "//div[@class='top']//input[@type='checkbox']"))
        )
        for element in elements:
            self.driver.execute_script("arguments[0].click();", element)
            time.sleep(2)

            self.do_send_keys((By.XPATH,"//div[@class='field-container']//input[@type='text']"),"https://facebook.com")
            break
